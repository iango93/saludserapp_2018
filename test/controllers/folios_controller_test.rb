...
class FoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folio" do
    assert_difference('Folio.count') do
      post folios_url, params: { folio: { customer_id: @folio.customer_id, folio: @folio.folio, headquarter_id: @folio.headquarter_id } }
    end
  ...
  test "should update folio" do
    patch folio_url(@folio), params: { folio: { customer_id: @folio.customer_id, folio: @folio.folio, headquarter_id: @folio.headquarter_id } }
